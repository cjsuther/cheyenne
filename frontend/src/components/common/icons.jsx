// Iconos SVG inline (estilo Lucide, MIT) — sin dependencias externas.
// Cada icono hereda el color via `currentColor` y acepta className para el tamaño.
...
export const IconAdministracion = (p) => (
  <Svg {...p}>
...
export const IconComunicacion = (p) => (
  <Svg {...p}>
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
  </Svg>
);

export const IconWav = (p) => (
  <Svg {...p}>
...
export const IconImportacion = (p) => (
  <Svg {...p}>
    <path d="M12 3v12" />
...
// Recursos Humanos: grupo de personas
export const IconRRHH = (p) => (
  <Svg {...p}>
