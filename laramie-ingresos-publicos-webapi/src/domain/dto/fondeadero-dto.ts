...
import VinculoFondeaderoState from './vinculo-fondeadero-state';
...
import DeclaracionJuradaState from './declaracion-jurada-state';
...
export default class FondeaderoDTO {
    ...
    vinculosFondeadero: Array<VinculoFondeaderoState>;
	...
	declaracionesJuradas: Array<DeclaracionJuradaState>;
        ...
        )
    {
        ...
        this.vinculosFondeadero = vinculosFondeadero;
    ...
    setFromObject = (row) =>
    {
        ...
        this.vinculosFondeadero = row.vinculosFondeadero.map(x => {
            let item = new VinculoFondeaderoState();
            item.setFromObject(x);
            return item;
        });
		...
		this.declaracionesJuradas = row.declaracionesJuradas.map(x => {
            let item = new DeclaracionJuradaState();
            item.setFromObject(x);
            return item;
        });
    }
