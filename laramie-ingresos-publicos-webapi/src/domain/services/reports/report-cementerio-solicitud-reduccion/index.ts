...
export default class ReportCementerioSolicitudReduccion {
    ...
    async generateReport(idCementerio:number, idInhumado: number) {
        return new Promise( async (resolve, reject) => {
            try {
                ...
                const numeroSolicitud:number = await this.numeracionService.findByProximo("CementerioSolicitudReduccion") as number;
                ...
                const optionsReport = {
                    ...
                    pathBodyTemplate: 'src/domain/services/reports/report-cementerio-solicitud-reduccion/index.ejs',
                ...
                const pdfReport = new PdfReport("SolicitudReduccion.pdf", "src/infraestructure/sdk/pdf-report", optionsReport);
