...
export default class ReportVehiculoBaja {
    ...
    async generateReport(idVehiculo:number) {
        return new Promise( async (resolve, reject) => {
            try {
                ...
                const motivoBajaVehiculo = motivosBajaVehiculos.find(f => f.id === vehiculo.idMotivoBajaVehiculo).nombre;
                ...
                const data = {
                    ...
                    fechaBaja: getDateToString(vehiculoDTO.vehiculo.fechaBaja, false),
                    codAutomor: "",
                ...
                const optionsReport = {
                    ...
                    pathBodyTemplate: 'src/domain/services/reports/report-vehiculo-baja/index.ejs',
                    pathHeaderTemplate: 'src/domain/services/reports/report-vehiculo-baja/header.ejs',
                    // pathFooterTemplate: '',
                ...
                const pdfReport = new PdfReport("SolicitudVehiculoBaja.pdf", "src/infraestructure/sdk/pdf-report", optionsReport);
