...
SELECT id
      ...
      ,id_clase_elemento
      ,id_unidad_medida
FROM LARAMIE.dbo.tipo_elemento
--FONDEADERO (NO APLICA)
--WHERE id IN (SELECT id_tipo_elemento FROM LARAMIE.dbo.elemento WHERE id_tipo_tributo=14 and cod_tasa='4046' and cod_subtasa in ())
--COMERCIO
WHERE id IN (SELECT id_tipo_elemento FROM LARAMIE.dbo.elemento WHERE id_tipo_tributo=11 and (
...
FROM LARAMIE.dbo.tipo_elemento
--FONDEADERO
--WHERE id IN (SELECT id_tipo_elemento FROM LARAMIE.dbo.elemento WHERE id_tipo_tributo=14 and cod_tasa='4046' and cod_subtasa in ('31','21','30','20','32','22','37','27','36','26','11','10','12','17','16','15','35','25'))
--COMERCIO
WHERE id IN (SELECT id_tipo_elemento FROM LARAMIE.dbo.elemento WHERE id_tipo_tributo=11 and (
