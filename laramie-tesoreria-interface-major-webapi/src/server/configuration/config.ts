...
export default {
  ...
  SESION_TIME: 3600000, // 60 minutos en ms,
  DELAY_UPDATE_SESION: 30000, // 30 segundos
  CHAR_DELIMITER: process.env.NODE_APP_CHAR_DELIMITER,
  SITE: {
    WEBAPI_SEGURIDAD: process.env.NODE_APP_URL_WEBAPI_SEGURIDAD,
    WEBAPI_TESORERIA: process.env.NODE_APP_URL_WEBAPI_TESORERIA,
    WEBAPI_TESORERIA_MAJOR: process.env.NODE_APP_URL_WEBAPI_TESORERIA_MAJOR
  },
  ACCESS_MAJOR: {
    USR: process.env.NODE_APP_ACCESS_MAJOR_USR,
    PSW: process.env.NODE_APP_ACCESS_MAJOR_PSW
  },
  mongo: {
  ...
  PATH: {
    ...
    RECIBO_PUBLICACION: process.env.NODE_APP_PATH_REPOSITORY + 'tesoreria-interface' + process.env.NODE_APP_PATH_SEPARATOR + 'recibo-publicacion' + process.env.NODE_APP_PATH_SEPARATOR,
    PAGO_RENDICION: process.env.NODE_APP_PATH_REPOSITORY + 'tesoreria-interface' + process.env.NODE_APP_PATH_SEPARATOR + 'pago-rendicion' + process.env.NODE_APP_PATH_SEPARATOR,
