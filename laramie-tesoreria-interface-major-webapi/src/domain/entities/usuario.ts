...
export default class Usuario {
    ...
    fechaAlta: Date;
    fechaBaja: Date;
    identificadorFirmaDigital: string;
    imagenFirmaDigital: string;
    idOficina: number;
        ...
        )
    {
        ...
        this.identificadorFirmaDigital = identificadorFirmaDigital;
    ...
    setFromObject = (row) =>
    {
        ...
        this.identificadorFirmaDigital = row.identificadorFirmaDigital ?? "";
        this.imagenFirmaDigital = row.imagenFirmaDigital ?? "";
        this.idOficina = row.idOficina ?? 0;
    }
