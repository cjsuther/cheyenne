...
class RegistroContableLote(Base):
    __tablename__ = "tesoreria_registro_contable_lotes"
    ...
    path_archivo_registro_contable = Column(String(500), nullable=True)

    registros = relationship("RegistroContable", back_populates="lote", lazy="dynamic")
