...
class PagoNotificacion(Base):
    ...
    id_transaccion_externa = Column(String(250), nullable=False, unique=True, index=True)
    comprobante_ref = Column(String(250), nullable=True)
    ...
    impacto_ok = Column(Boolean, nullable=False, default=False)
    impacto_detalle = Column(Text, nullable=True)
