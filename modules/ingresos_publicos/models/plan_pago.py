...
class PlanPago(Base):
    __tablename__ = "ingresos_publicos_planes_pago"

    id = Column(BigInteger, primary_key=True, autoincrement=True)
    id_plan_pago_definicion = Column(BigInteger, ForeignKey("ingresos_publicos_plan_pago_definiciones.id"), nullable=True)
    ...
    numero_plan = Column(Integer, nullable=True)
