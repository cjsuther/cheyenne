...
export default class CuentaPagoController {
	...
	get = (req, res, next) => {
		...
		this.cuentaPagoService.list(token)
	...
	getById = (req, res, next) => {
		...
		this.cuentaPagoService.findById(token, id)
	...
	post = (req, res, next) => {
		...
		this.cuentaPagoService.add(token, dataBody)
			.then(row => res.send(row))
			.catch(next)
	}
	...
	postAnticipado = (req, res, next) => {
		...
		this.cuentaPagoService.addAnticipado(token, dataBody)
			.then(row => res.send(row))
			.catch(next)
	}
	...
	put = (req, res, next) => {
		...
		this.cuentaPagoService.modify(token, id, dataBody)
			.then(row => res.send(row))
			.catch(next)
	}
	...
	delete = (req, res, next) => {
		...
		this.cuentaPagoService.remove(token, id)
			.then(id => res.send(id))
			.catch(next)
	}
