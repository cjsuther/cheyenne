...
const ToolbarFormula = (props) => {
  ...
  //variables
  const listFields = [
    {id: -1, codigo: "CAMPO_TIPO", nombre: "Tipo", grupo: 'ET'},
    {id: -2, codigo: "CAMPO_CANTIDAD", nombre: "Cantidad", grupo:'E'},
    {id: -3, codigo: "CAMPO_VALOR", nombre: "Valor", grupo: 'E'},
    {id: -4, codigo: "CAMPO_ALICUOTA", nombre: "Alicuota", grupo: 'T'},
    {id: -5, codigo: "CAMPO_MINIMO", nombre: "Mínimo", grupo: 'T'},
    {id: -6, codigo: "CAMPO_ING_BRUTO", nombre: "Monto Ingreso Bruto", grupo: 'T'},
    {id: -7, codigo: "CAMPO_DEDUCCIONES", nombre: "Monto Deducciones", grupo: 'T'},
    {id: -8, codigo: "CAMPO_ING_NETO", nombre: "Monto Ingreso Neto", grupo: 'T'},
    {id: -9, codigo: "CAMPO_REG_GENERAL", nombre: "Rubro de Régimen General", grupo: 'T'}
  ]
  ...
  const [state, setState] = useState({
    ...
    listParametros: [],
    listElementos: [],
    listEntidades: [{id: -1, codigo: "LISTA_RUBROS", nombre: "Rubros de Comercio", grupo: 'T'}],
  });
