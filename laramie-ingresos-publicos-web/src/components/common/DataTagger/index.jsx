  ...
  function AddEntidad() {
    ...
    if (state.tabActive === DATA_TAGGER_TYPE.ARCHIVO) {
      ...
      if (formValues.Observacion_detalle.length <= 0) {
        ShowToastMessage(ALERT_TYPE.ALERT_WARNING, 'Debe cargar el detalle');
        return;
      }
        ...
        <div className="modal-dialog">
          <div className="modal-content animated fadeIn">
            <div className="modal-header">
              ...
              <i className="modal-icon fa fa-file"></i>
            </div>
        ...
        <div className="modal-dialog">
          <div className="modal-content animated fadeIn">
            <div className="modal-header">
              ...
              <i className="modal-icon fa fa-comment"></i>
            </div>
            <div className="modal-body">
              <div className="row">
        ...
        <div className="modal-dialog">
          <div className="modal-content animated fadeIn">
            <div className="modal-header">
              ...
              <i className="modal-icon fa fa-tag"></i>
            </div>
            <div className="modal-body">
              <div className="row">
