...
const VinculoVehiculoModal = (props) => {
  ...
  const mount = () => {
    ...
    formSet({
      idTipoVinculoVehiculo: props.data.entity.idTipoVinculoVehiculo,
  ...
  const handleClickAceptar = () => {
    if (isFormValid()) {
      ...
      row.idTipoVinculoVehiculo = parseInt(formValues.idTipoVinculoVehiculo);
  ...
  function isFormValid() {
    ...
    if (formValues.idTipoVinculoVehiculo <= 0) {
      ShowToastMessage(ALERT_TYPE.ALERT_WARNING, 'Debe cargar el campo Tipo Vínculo Vehiculo');
      return false;
    }
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content animated fadeIn">
          <div className="modal-header">
            <h2 className="modal-title">Persona del Vehiculo: {(state.entity.id > 0) ? state.entity.nombreApellido : "Nuevo"}</h2>
          </div>
          <div className="modal-body">
            <div className="row">
                
                <div className="mb-3 col-12 col-md-6">
                    <label htmlFor="idTipoVinculoVehiculo" className="form-label">Tipo Vínculo</label>
                    <InputLista
                        name="idTipoVinculoVehiculo"
                        placeholder=""
                        className="form-control"
                        value={ formValues.idTipoVinculoVehiculo }
                        onChange={ formHandle }
                        disabled={props.disabled}
                        lista="TipoVinculoVehiculo"
                    />
                </div>
                <div className="mb-3 col-12 col-md-6">
...
VinculoVehiculoModal.propTypes = {
...
VinculoVehiculoModal.defaultProps = {
  disabled: false
};

export default VinculoVehiculoModal;