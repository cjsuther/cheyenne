...
const VinculoFondeaderoModal = (props) => {
  ...
  const mount = () => {
    ...
    formSet({
      idTipoVinculoFondeadero: props.data.entity.idTipoVinculoFondeadero,
  ...
  const handleClickAceptar = () => {
    if (isFormValid()) {
      ...
      row.idTipoVinculoFondeadero = parseInt(formValues.idTipoVinculoFondeadero);
  ...
  function isFormValid() {
    ...
    if (formValues.idTipoVinculoFondeadero <= 0) {
      ShowToastMessage(ALERT_TYPE.ALERT_WARNING, 'Debe cargar el campo Tipo Vínculo Fondeadero');
      return false;
    }
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content animated fadeIn">
          <div className="modal-header">
            <h2 className="modal-title">Persona del Fondeadero: {(state.entity.id > 0) ? state.entity.nombreApellido : "Nuevo"}</h2>
          </div>
          <div className="modal-body">
            <div className="row">
                
                <div className="mb-3 col-12 col-md-6">
                    <label htmlFor="idTipoVinculoFondeadero" className="form-label">Tipo Vínculo</label>
                    <InputLista
                        name="idTipoVinculoFondeadero"
                        placeholder=""
                        className="form-control"
                        value={ formValues.idTipoVinculoFondeadero }
                        onChange={ formHandle }
                        disabled={props.disabled}
                        lista="TipoVinculoFondeadero"
                    />
                </div>
                <div className="mb-3 col-12 col-md-6">
...
VinculoFondeaderoModal.propTypes = {
...
VinculoFondeaderoModal.defaultProps = {
  disabled: false
};

export default VinculoFondeaderoModal;