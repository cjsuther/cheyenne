        ...
        <div className="col-12 m-top-10">
          {!props.disabled && !state.modeFormEdit && (
            <button className="btn btn-primary btn-map float-end" onClick={ (event) => handleClickInitEdit() }>
              <i className="fa fa-map-marker-alt" title="modificar dirección"></i>
            </button>
          )}
          {!props.disabled && state.modeFormEdit && (
            <>
            <button className="btn btn-outline-primary btn-map float-end m-left-5" onClick={ (event) => handleClickDismissEdit() }>
              <i className="fa fa-times" title="cancelar"></i>
            </button>
            <button className="btn btn-primary btn-map float-end" onClick={ (event) => handleClickConfirmEdit() }>
              <i className="fa fa-check" title="aceptar"></i>
            </button>
            </>
          )}
        </div>
