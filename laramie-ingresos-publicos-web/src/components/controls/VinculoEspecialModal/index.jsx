...
const VinculoEspecialModal = (props) => {
  ...
  const mount = () => {
    ...
    formSet({
      idTipoVinculoEspecial: props.data.entity.idTipoVinculoEspecial,
  ...
  const handleClickAceptar = () => {
    if (isFormValid()) {
      ...
      row.idTipoVinculoEspecial = parseInt(formValues.idTipoVinculoEspecial);
  ...
  function isFormValid() {
    ...
    if (formValues.idTipoVinculoEspecial <= 0) {
      ShowToastMessage(ALERT_TYPE.ALERT_WARNING, 'Debe cargar el campo Tipo Vínculo Especial');
      return false;
    }
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content animated fadeIn">
          <div className="modal-header">
            <h2 className="modal-title">Persona del Especial: {(state.entity.id > 0) ? state.entity.nombreApellido : "Nuevo"}</h2>
          </div>
          <div className="modal-body">
            <div className="row">
                
                <div className="mb-3 col-12 col-md-6">
                    <label htmlFor="idTipoVinculoEspecial" className="form-label">Tipo Vínculo</label>
                    <InputLista
                        name="idTipoVinculoEspecial"
                        placeholder=""
                        className="form-control"
                        value={ formValues.idTipoVinculoEspecial }
                        onChange={ formHandle }
                        disabled={props.disabled}
                        lista="TipoVinculoEspecial"
                    />
                </div>
                <div className="mb-3 col-12 col-md-6">
...
VinculoEspecialModal.propTypes = {
...
VinculoEspecialModal.defaultProps = {
  disabled: false
};

export default VinculoEspecialModal;