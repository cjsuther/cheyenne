...
const VinculoCementerioModal = (props) => {
  ...
  const mount = () => {
    ...
    formSet({
      idTipoVinculoCementerio: props.data.entity.idTipoVinculoCementerio,
  ...
  const handleClickAceptar = () => {
    if (isFormValid()) {
      ...
      row.idTipoVinculoCementerio = parseInt(formValues.idTipoVinculoCementerio);
  ...
  function isFormValid() {
    ...
    if (formValues.idTipoVinculoCementerio <= 0) {
      ShowToastMessage(ALERT_TYPE.ALERT_WARNING, 'Debe cargar el campo Tipo Vínculo Cementerio');
      return false;
    }
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content animated fadeIn">
          <div className="modal-header">
            <h2 className="modal-title">Persona del Cementerio: {(state.entity.id > 0) ? state.entity.nombreApellido : "Nuevo"}</h2>
          </div>
          <div className="modal-body">
            <div className="row">
                
                <div className="mb-3 col-12 col-md-6">
                    <label htmlFor="idTipoVinculoCementerio" className="form-label">Tipo Vínculo</label>
                    <InputLista
                        name="idTipoVinculoCementerio"
                        placeholder=""
                        className="form-control"
                        value={ formValues.idTipoVinculoCementerio }
                        onChange={ formHandle }
                        disabled={props.disabled}
                        lista="TipoVinculoCementerio"
                    />
                </div>
                <div className="mb-3 col-12 col-md-6">
...
VinculoCementerioModal.propTypes = {
...
VinculoCementerioModal.defaultProps = {
  disabled: false
};

export default VinculoCementerioModal;