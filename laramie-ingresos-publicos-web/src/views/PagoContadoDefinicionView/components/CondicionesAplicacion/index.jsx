...
import { AccordionIcon, DatePickerCustom, InputLista, InputListaMulti, InputNumber } from '../../../../components/common'
            ...
            <div className='accordion-body'>
                <div className='row form-basic'>
                    ...
                    <InputListaMulti
                        ...
                        data={otherValues.pagosContadoDefinicionAlcanceCondicionFiscal}
                        setData={data => {setOtherValues(prev => ({...prev, pagosContadoDefinicionAlcanceCondicionFiscal: data})); setPendingChange(true)}}
                        newItemFiller={{ idPagoContadoDefinicion: parseInt(params.id) }}
                        disabled={params.mode === OPERATION_MODE.VIEW}
                        debug
                    />
                    <InputListaMulti
                        ...
                        data={otherValues.pagosContadoDefinicionAlcanceFormaJuridica}
                        setData={data => {setOtherValues(prev => ({...prev, pagosContadoDefinicionAlcanceFormaJuridica: data})); setPendingChange(true)}}
                        newItemFiller={{ idPagoContadoDefinicion: parseInt(params.id) }}
                        disabled={params.mode === OPERATION_MODE.VIEW}
                    />
                    <InputListaMulti
                        ...
                        key='Rubro'
                        idField='idRubro'
                        data={otherValues.pagosContadoDefinicionAlcanceRubro}
                        setData={data => {setOtherValues(prev => ({...prev, pagosContadoDefinicionAlcanceRubro: data})); setPendingChange(true)}}
                        newItemFiller={{ idPagoContadoDefinicion: parseInt(params.id) }}
                        disabled={params.mode === OPERATION_MODE.VIEW}
                    />
                    <InputListaMulti
                        ...
                        data={otherValues.pagosContadoDefinicionAlcanceZonaTarifaria}
                        setData={data => {setOtherValues(prev => ({...prev, pagosContadoDefinicionAlcanceZonaTarifaria: data})); setPendingChange(true)}}
                        newItemFiller={{ idPagoContadoDefinicion: parseInt(params.id) }}
                        disabled={params.mode === OPERATION_MODE.VIEW}
                    />
                    <InputListaMulti
                        ...
                        type='entidad'
                        idField='idGrupo'
                        data={otherValues.pagosContadoDefinicionAlcanceGrupo}
                        setData={data => {setOtherValues(prev => ({...prev, pagosContadoDefinicionAlcanceGrupo: data})); setPendingChange(true)}}
                        newItemFiller={{ idPagoContadoDefinicion: parseInt(params.id) }}
                        disabled={params.mode === OPERATION_MODE.VIEW}
                    />
                    <InputListaMulti
                        ...
                        idField='idRubroAfip'
                        className="col-12"
                        data={otherValues.pagosContadoDefinicionAlcanceRubroAfip}
                        setData={data => {setOtherValues(prev => ({...prev, pagosContadoDefinicionAlcanceRubroAfip: data})); setPendingChange(true)}}
                        newItemFiller={{ idPagoContadoDefinicion: parseInt(params.id) }}
                        disabled={params.mode === OPERATION_MODE.VIEW}
                    />
                    <div className="col-12 col-md-6 col-lg-4">
                    ...
                    <Tasas
                        tasas={otherValues.pagosContadoDefinicionAlcanceTasa}
                        setTasas={data => {setOtherValues(prev => ({...prev, pagosContadoDefinicionAlcanceTasa: data})); setPendingChange(true)}}
                        params={params}
                    />
                </div>
            </div>
