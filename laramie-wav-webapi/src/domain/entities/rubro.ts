export default class Rubro {
	...
	constructor(
		...
		idTipoMinimoAplicable: number = 0
	)
	{
        this.id = id;
		this.codigo = codigo;
		...
		this.idTipoMinimoAplicable = idTipoMinimoAplicable;
	}
	...
	setFromObject = (row) =>
	{
        ...
        this.idTipoMinimoAplicable = row.idTipoMinimoAplicable ?? 0;
	}
