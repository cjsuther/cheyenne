...
function Header() {
    ...
    const [modalState, setModalState] = useState({ show: false, component: null })
    const setModal = (component) => {
        setModalState({ show: true, component })
    }
    ...
    const context = { isAuthenticated, publicRoutes, privateRoutes, handleClickHome, handleClickMenu, handleClickLogout, setModal }

    const CurrentModal = modalState.component
    ...
    return <>
        <HeaderContext.Provider value={context}>
            ...
            {modalState.show && <CurrentModal close={() => setModalState({ show: false, component: null })} />}
