...
import { GeoCode_GSV } from '../../utils/GeoCodeGSV';

export const useGeoGSV = ( initialState = {
    country: '',
    state: '',
    city: '',
    town: '',
    ...
    const process = () => {
        ...
        // else {
        //     setLocation({lat: location.lat, lng: location.lng, status: 3, message: 'GSV: Existen campos incompletos'});
        // }
    }
