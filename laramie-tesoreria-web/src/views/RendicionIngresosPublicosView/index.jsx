...
const RendicionIngresosPublicosView = () => {
    ...
    const RendirIngresosPublicos = () => {
        ...
        ServerRequest(
            ...
            '/ingresos-publicos',
            dataBody,
            res => res.json().then(({idPagoRendicionLote}) => {
                ShowToastMessage(ALERT_TYPE.ALERT_SUCCESS, 'Rendición a ingresos públicos exitosa')
    ...
    const handleRendirIngresosPublicos = () => {
        ...
        showMessageModal({
            ...
            onConfirm: () => RendirIngresosPublicos(),
        })
    }

    return <>
        <SectionHeading titles={[{ title: 'Rendiciones' }, { title: 'Rendición a ingresos públicos' }]} />
        ...
        <footer className='footer footer-action'>
            <div className='footer-action-container'>
                <button className="btn action-button float-end" onClick={ (event) => handleRendirIngresosPublicos() }>Confirmar</button>
            </div>
        </footer>
...
export default RendicionIngresosPublicosView
