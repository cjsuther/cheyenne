...
import { DeudaPeriodoArba } from './arba-vehiculo/deuda-periodo-arba';
import { DeudaMoratoriaArba } from './arba-vehiculo/deuda-moratoria-arba.';
...
export default class VehiculoDTO {
    ...
    deudasPeriodoArba: Array<DeudaPeriodoArba>;
    deudasMoratoriaArba: Array<DeudaMoratoriaArba>;
    ...
    )
    {
        ...
        this.deudasPeriodoArba = deudasPeriodoArba;
        this.deudasMoratoriaArba = deudasMoratoriaArba;
    }
    ...
    setFromObject = (row) =>
    {
        ...
        // this.deudasPeriodoArba = row.deudasPeriodoArba.map(x => {
        //     let item = new DeudaPeriodoArba();
        //     item.setFromObject(x);
        //     return item;
        // });
        // this.deudasMoratoriaArba = row.deudasMoratoriaArba.map(x => {
        //     let item = new DeudaMoratoriaArba();
        //     item.setFromObject(x);
        //     return item;
        // });
    }
